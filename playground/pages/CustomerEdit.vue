...
import ElementPlusDialog from "./ElementPlusDialog.vue";
...
const showElementPlusDialog = ref(false);
...
<template>
  <el-card header="客户编辑（CustomerEdit）">
    ...
    <el-space>
      ...
      <el-button @click="showElementPlusDialog = true">
        编辑订单（Element Plus Dialog）
      </el-button>
    ...
    <ElementPlusDialog v-model="showElementPlusDialog" />
  </el-card>
</template>
